package doc.procesos.studenttransfer.inicial;
...
public class WaitingDoorProperty extends DoorActionProperty {
  public WaitingDoorProperty() {
    ...
    exitProperty0.setGoto(new org.monet.metamodel.internal.Ref("Finalizar","doc.procesos.StudentTransfer","doc.procesos.StudentTransfer.Finalizar"));

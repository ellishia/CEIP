...
import solicitud.solicituddoc.schema.Entry;

@Root(name = "schema", strict = false)
@SuppressWarnings("all")
public class Schema implements org.monet.bpi.Schema {
  @Element(name = "Address", required = false)
  private Address Address = new solicitud.solicituddoc.schema.Address();
  ...
  private ArrayList<Entry> entry = new java.util.ArrayList<solicitud.solicituddoc.schema.Entry>();

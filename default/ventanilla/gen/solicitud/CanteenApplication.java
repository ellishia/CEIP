...
public class CanteenApplication extends ServiceApplication {
  public FieldSerial getIdentifierField() {
    return ((org.monet.bpi.FieldSerial)this.getField("CanteenApplication", "Identifier"));
  }
  
  public String getIdentifier() {
    return ((org.monet.bpi.FieldSerial)this.getField("CanteenApplication", "Identifier")).get();
  }
  ...
  public static CanteenApplication createNew(final Node parent) {
    return (solicitud.CanteenApplication)org.monet.bpi.NodeService.create(solicitud.CanteenApplication.class, parent);
  }
}

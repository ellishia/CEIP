...
public class AsignationsCards extends NodeCollectionImpl {
  ...
  public static AsignationsCards createNew(final Node parent) {
    return (direc.AsignationsCards)org.monet.bpi.NodeService.create(direc.AsignationsCards.class, parent);
  }
}

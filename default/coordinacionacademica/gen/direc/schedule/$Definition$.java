...
public class $Definition$ extends CollectionDefinition implements HasBehaviour, HasClientBehaviour {
  public $Definition$() {
    ...
    indexProperty7.setSortBy(new org.monet.metamodel.internal.Ref("Slot","direc.Schedule.Indice","direc.Schedule.Indice.Slot"));
    ...
    dimensionProperty11.getAttribute().add(new org.monet.metamodel.internal.Ref("Slot","direc.Schedule.Indice","direc.Schedule.Indice.Slot"));
    ...
    sortingProperty13.getAttribute().add(new org.monet.metamodel.internal.Ref("Slot","direc.Schedule.Indice","direc.Schedule.Indice.Slot"));
    sortingProperty13.getAttribute().add(new org.monet.metamodel.internal.Ref("Teacher","direc.Schedule.Indice","direc.Schedule.Indice.Teacher"));

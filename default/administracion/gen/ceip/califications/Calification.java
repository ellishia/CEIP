...
public class Calification extends NodeFormImpl {
  ...
  public FieldSelect getLevelField() {
    return ((org.monet.bpi.FieldSelect)this.getField("Calification", "Level"));
  }
  
  public Term getLevel() {
    return ((org.monet.bpi.FieldSelect)this.getField("Calification", "Level")).get();
  }
  ...
  public Indice getIndice() {
    return (ceip.califications.Indice)this.getIndexEntry("ceip.Califications.Indice");
  }
  ...
  public static Calification createNew(final Node parent) {
    return (ceip.califications.Calification)org.monet.bpi.NodeService.create(ceip.califications.Calification.class, parent);
  }
}

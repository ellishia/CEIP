...
import ceip.procesos.recibirsolicitudplaza.Place;
...
public class RecibirSolicitudPlaza extends ServiceImpl {
  ...
  public static RecibirSolicitudPlaza createNew() {
    return (ceip.procesos.RecibirSolicitudPlaza)org.monet.bpi.TaskService.create(ceip.procesos.RecibirSolicitudPlaza.class);
  }

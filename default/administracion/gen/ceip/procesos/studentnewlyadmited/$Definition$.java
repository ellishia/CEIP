...
public class $Definition$ extends ActivityDefinition implements HasBehaviour, HasClientBehaviour {
  public $Definition$() {
    ...
    org.monet.metamodel.ActivityDefinition.ActivityPlaceProperty activityPlaceProperty23 = new org.monet.metamodel.ActivityDefinition.ActivityPlaceProperty();
    activityPlaceProperty23.setCode("mujxbea");
    activityPlaceProperty23.setName("Enviando");
    org.monet.metamodel.SendRequestActionProperty sendRequestActionProperty23 = new org.monet.metamodel.SendRequestActionProperty();
    sendRequestActionProperty23.setLabel("Enviando Documento");
    sendRequestActionProperty23.setHistory("Documento enviado");
    sendRequestActionProperty23.setRequest(new org.monet.metamodel.internal.Ref("Admitidos","ceip.procesos.StudentNewlyAdmited","ceip.procesos.StudentNewlyAdmited.ProviderName.Admitidos"));
    sendRequestActionProperty23.setProvider(new org.monet.metamodel.internal.Ref("ProviderName","ceip.procesos.StudentNewlyAdmited","ceip.procesos.StudentNewlyAdmited.ProviderName"));
    sendRequestActionProperty23.setGoto(new org.monet.metamodel.internal.Ref("Finalizado","ceip.procesos.StudentNewlyAdmited","ceip.procesos.StudentNewlyAdmited.Finalizado"));
    sendRequestActionProperty23.setCode("m8i22bg");
    activityPlaceProperty23.setSendRequestActionProperty(sendRequestActionProperty23);
    this.addPlace(activityPlaceProperty23);
    org.monet.metamodel.ActivityDefinition.ActivityPlaceProperty activityPlaceProperty30 = new org.monet.metamodel.ActivityDefinition.ActivityPlaceProperty();
    activityPlaceProperty30.setCode("mzbebbg");
    activityPlaceProperty30.setName("Finalizado");
    activityPlaceProperty30.setIsFinal(true);
    this.addPlace(activityPlaceProperty30);

...
public class AvailablePositions extends NodeCollectionImpl {
  ...
  public static AvailablePositions createNew(final Node parent) {
    return (ceip.AvailablePositions)org.monet.bpi.NodeService.create(ceip.AvailablePositions.class, parent);
  }
}

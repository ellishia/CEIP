...
public class SetupUni_rayco extends Manifest {
  public SetupUni_rayco() {
    ...
    spaceProperty2.setDeployUri(java.net.URI.create("http://10.13.13.191:8091/administracion"));
    ...
    federationProperty10.setSetupUri(java.net.URI.create("http://10.13.13.191:8091/empresa"));
